...
define(['jquery', 'backbone'], function ($, Backbone) {
    ...
    var ComBroker = Backbone.Controller.extend({
        ...
        listenWebViews: function (event, func) {
            var self = this;
            return supersonic.data.channel(event).subscribe(function (data, reply) {
        ...
        fireWebViews: function (event, fromWebView, data) {
            var self = this;
            supersonic.data.channel(event).publish({
